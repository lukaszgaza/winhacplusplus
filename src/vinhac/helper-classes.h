...
class DualString {
	...
	public :
	/**
	 * \brief construct from XMLCh
	 *
	 * @param original base of construction
	 */
	...
	/**
	 * \brief converts DualString to C-String
	 *
	 * @return C-string
	 */
	...
	/**
	 * \brief converts DualString to XMLCh
	 *
	 * @return XMLCh
	 */
	...
	/**
	 * \brief prints it to output stream
	 *
	 * @param s stream to print in
	 * @return stream
	 */
