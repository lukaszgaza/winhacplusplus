...
private:
	...
	std::vector<int> dQuarks;
	std::vector<int> dAntiQuarks;
	std::vector<int> uQuarks;
	std::vector<int> uAntiQuarks;
...
public:
	 ...
	 */
	ppWintegrand(BeamHandler *beamHandler);
	~ppWintegrand() {
	}
	 ...
	 * @return minimal x
	 */
	inline const double& getXminimal() const {
		return xminimal;
	}
	 ...
	 * @return \f$x_{min}\f$
	 */
	inline const double& getX_min() const {
		return x_min;
	}
	 ...
	 * @return \f$x_{max}\f$
	 */
	inline const double& getX_max() const {
		return x_max;
	}
	 ...
	 * @return a
	 */
	inline const double& getA() const {
		return a;
	}
	 ...
	 * @return b
	 */
	inline const double& getB() const {
		return b;
	}
