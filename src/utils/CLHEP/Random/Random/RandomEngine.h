 ...
 * @ingroup random
 */
class HepRandomEngine: public TRND
{

public:
	/* FROM FOAM INTEFACE TRND */
	virtual void SetSeed(long seed){
		throw "In hep random Engine, use setSeed, not SetSeed";
	}

	/* FROM FOAM INTEFACE TRND */
	virtual double Flat(void){
		return flat();
	}
...
//BOOST_IS_ABSTRACT(HepRandomEngine)
...
#include "../Random/RandomEngine.icc"
